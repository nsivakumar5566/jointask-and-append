...
<div class="container mt-5">
 ...
 <form action="{{ route('city.store')}}" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control"  name="city_name" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" name="city_code" id="exampleInputPassword1">
